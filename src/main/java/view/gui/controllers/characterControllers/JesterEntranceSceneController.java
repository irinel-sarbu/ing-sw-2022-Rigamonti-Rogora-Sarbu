...
import view.gui.controllers.IslandSelectorSceneController;
...
public class JesterEntranceSceneController implements GenericSceneController {
    ...
    public void onStudent0(MouseEvent mouseEvent) {
        ...
        if (entranceStudents.size() >= 3) {
            EventManager.notify(new EUseJesterEffect(entranceStudents, jesterStudents));
        }
    }
