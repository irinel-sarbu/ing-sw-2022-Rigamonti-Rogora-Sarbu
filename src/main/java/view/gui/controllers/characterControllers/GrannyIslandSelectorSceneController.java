...
import eventSystem.events.network.client.EUseGrannyEffect;
...
public class GrannyIslandSelectorSceneController implements GenericSceneController {
    LightModel model;
